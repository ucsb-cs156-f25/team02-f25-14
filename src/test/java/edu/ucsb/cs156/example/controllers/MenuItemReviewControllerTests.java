...
public class MenuItemReviewControllerTests extends ControllerTestCase {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    MenuItemReview menuItemReview =
        MenuItemReview.builder()
            .itemId(1)
            .reviewerEmail("testEmail1@gmail.com")
            .stars(4)
            .dateReviewed(ldt)
            .comments("Not Bad")
            .build();
  ...
  public void logged_in_user_can_get_all_menuitemreview() throws Exception {
    ...
    MenuItemReview menuItemReview2 =
        MenuItemReview.builder()
            .itemId(2)
            .reviewerEmail("testEmail2@gmail.com")
            .stars(4)
            .dateReviewed(ldt2)
            .comments("Not Bad")
            .build();
  ...
  public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreview/post?itemId=1&reviewerEmail=testEmail1@gmail.com&stars=4&dateReviewed=2022-01-03T00:00:00&comments=reviewed")
                    .with(csrf()))
  ...
  public void admin_can_delete_a_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/menuitemreview?id=123").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void admin_can_edit_an_existing_menuitemreview() throws Exception {
    ...
    MenuItemReview menuItemReviewOrig =
        MenuItemReview.builder()
            .itemId(1)
            .reviewerEmail("original@gmail.com")
            .stars(1)
            .dateReviewed(ldt1)
            .comments("Not Bad")
            .build();
    ...
    MenuItemReview menuItemReviewEdited =
        MenuItemReview.builder()
            .itemId(11)
            .reviewerEmail("edited@gmail.com")
            .stars(5)
            .dateReviewed(ldt2)
            .comments("Very Good")
            .build();
